...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-26 relative">
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="blob w-96 h-96 bg-accent3"
      ...
      <div ref={ref} className="section-reveal max-w-6xl mx-auto px-6">
        ...
        <div className="flex items-center gap-4 mb-4">
          <span className="font-mono text-sm text-accent tracking-widest">02.</span>
          <h2 className="font-display font-bold text-3xl sm:text-4xl text-text">Tech Stack</h2>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className="w-8 h-8 rounded-md flex items-center justify-center text-sm font-mono font-bold flex-shrink-0"
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill) => (
                    <span
                      key={skill}
                      className="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-mono font-medium transition-all duration-200 cursor-default"
                      style={{
        ...
        {/* Proficiency callout */}
        <div className="mt-10 glass rounded-xl p-6 flex flex-col sm:flex-row items-center gap-6">
          <div className="flex-1">
            <h4 className="font-display font-semibold text-text mb-1">Always Learning</h4>
          ...
          <div className="flex gap-4 text-center">
            {[
              ...
              <div key={stat.label}>
                <div className="font-display font-bold text-2xl text-accent">{stat.val}</div>
